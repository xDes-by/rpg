local function damage(self)
	...
	local formulas = {
		...
		["npc_dota_hero_death_prophet"] = {min = (parent:GetStrength() + self.eng) / 5, max = (parent:GetStrength() + self.str) / 3},
	}
...
local function speed(self)
	...
	local formulas = {
		...
		["npc_dota_hero_death_prophet"] = {speed = parent:GetAgility() / 10},
	}
...
local function armor(self)
	...
	local formulas = {
		...
		["npc_dota_hero_death_prophet"] = {armor = parent:GetAgility() / 4},
	}
...
local heroes_stats = {
    ["npc_dota_hero_juggernaut"] = {str = 28, agi = 20, vit = 25, eng = 10, hp = 110, mp = 20, hp_per_level = 2, mp_per_level = 0.5, hp_per_vit = 3, mp_per_eng = 1, damage = damage, speed = speed, armor = armor}, 		-- воин 
    ["npc_dota_hero_death_prophet"] = {str = 18, agi = 18, vit = 15, eng = 30, hp = 60, mp = 60, hp_per_level = 1, mp_per_level = 2, hp_per_vit = 1, mp_per_eng = 2, damage = damage, speed = speed, armor = armor},		-- маг
}
