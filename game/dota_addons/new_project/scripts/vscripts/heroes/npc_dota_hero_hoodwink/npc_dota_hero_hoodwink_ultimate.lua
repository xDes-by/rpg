npc_dota_hero_hoodwink_ultimate = class({})

function npc_dota_hero_hoodwink_ultimate:OnSpellStart()
	self.target = self:GetCursorTarget()
	self:PlayEffects()
end

function npc_dota_hero_hoodwink_ultimate:PlayEffects()
...
function npc_dota_hero_hoodwink_ultimate:OnChannelFinish( bInterrupted )
...
function npc_dota_hero_hoodwink_ultimate:OnProjectileHit_ExtraData( target, location, extradata )
