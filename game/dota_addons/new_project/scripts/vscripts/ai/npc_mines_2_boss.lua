mines_2_boss_ability = {"ability_npc_boss_mines_2_spell_1","ability_npc_boss_mines_2_spell_2","ability_npc_boss_mines_2_spell_3","ability_npc_boss_mines_2_spell_4", "ability_npc_boss_mines_2_spell_6"}
...
function Spawn( entityKeyValues )
	...
	NoTargetAbility = thisEntity:FindAbilityByName( "ability_npc_boss_mines_2_spell_5" )
...
function NeutralThink()
	...
	thisEntity.vInitialSpawnPos  = Vector(15020,3234,128)
	...
	if #all > 0 then	
		for _,unit in pairs(all) do
			if unit:HasModifier("modifier_ability_npc_boss_mines_2_spell_3_root") then
	...
	if #enemies > 0 then
	enemy = enemies[1]
		for _, T in ipairs(mines_2_boss_ability) do
