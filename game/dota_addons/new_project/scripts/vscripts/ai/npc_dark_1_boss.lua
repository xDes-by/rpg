dark_1_boss_ability = {"ability_npc_boss_dark_1_spell1","ability_npc_boss_dark_1_spell2","ability_npc_boss_dark_1_spell3","ability_npc_boss_dark_1_spell4", "ability_npc_boss_dark_1_spell5", "ability_npc_boss_dark_1_spell6"}
...
function NeutralThink()
	...
	thisEntity.vInitialSpawnPos  = Vector(-11333,1307, 256)
	...
	if #enemies > 0 then
	enemy = enemies[1]
		for _, T in ipairs(dark_1_boss_ability) do
