jungle_1_boss_ability = {"ability_npc_boss_jungle1_1_spell_1","ability_npc_boss_jungle1_1_spell_2","ability_npc_boss_jungle1_1_spell_3","ability_npc_boss_jungle1_1_spell_4", "ability_npc_boss_jungle1_1_spell_5", "ability_npc_boss_jungle1_1_spell_6"}
...
function NeutralThink()
	...
	thisEntity.vInitialSpawnPos  = Vector(-6675,-2997, 16)
	...
	if #enemies > 0 then
	enemy = enemies[1]
		for _, T in ipairs(jungle_1_boss_ability) do
