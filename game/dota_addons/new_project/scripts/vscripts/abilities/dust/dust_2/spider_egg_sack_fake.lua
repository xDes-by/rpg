LinkLuaModifier( "modifier_spider_egg_sack_fake", "abilities/dust/dust_2/spider_egg_sack_fake", LUA_MODIFIER_MOTION_NONE )

spider_egg_sack_fake = class({})

function spider_egg_sack_fake:GetIntrinsicModifierName()
	return "modifier_spider_egg_sack_fake"
end

-------------------------------------------------------------------------

modifier_spider_egg_sack_fake = class({})

function modifier_spider_egg_sack_fake:IsHidden()
	return true
end

function modifier_spider_egg_sack_fake:CheckState()
	local state =
	{
...
function modifier_spider_egg_sack_fake:OnCreated( kv )
	if IsServer() then
...
function modifier_spider_egg_sack_fake:OnIntervalThink()
	if IsServer() then
...
function modifier_spider_egg_sack_fake:Burst()
	if IsServer() then
