...
LinkLuaModifier( "modifier_ability_npc_boss_hell2_spell5","abilities/hell2/ability_npc_boss_hell2_spell5", LUA_MODIFIER_MOTION_BOTH )
LinkLuaModifier( "modifier_ability_npc_boss_hell2_spell5_tornado","abilities/hell2/ability_npc_boss_hell2_spell5", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_npc_boss_hell2_spell5_thinker","abilities/hell2/ability_npc_boss_hell2_spell5", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_npc_boss_hell2_spell5_effect","abilities/hell2/ability_npc_boss_hell2_spell5", LUA_MODIFIER_MOTION_NONE )
