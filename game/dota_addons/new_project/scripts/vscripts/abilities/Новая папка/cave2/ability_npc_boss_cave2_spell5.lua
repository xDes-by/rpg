ability_npc_boss_cave2_spell5 = class({})

LinkLuaModifier( "modifier_ability_npc_boss_cave2_spell5","abilities/cave2/ability_npc_boss_cave2_spell5", LUA_MODIFIER_MOTION_NONE )

function ability_npc_boss_cave2_spell5:OnSpellStart()
    self:GetCaster():StartGestureWithPlaybackRate(ACT_DOTA_CAST_ABILITY_2, 0.1)
    self:GetCaster():AddNewModifier(self:GetCaster(), self, "modifier_ability_npc_boss_cave2_spell5", {})
end

modifier_ability_npc_boss_cave2_spell5 = class({})
--Classifications template
function modifier_ability_npc_boss_cave2_spell5:IsHidden()
    return true
end

function modifier_ability_npc_boss_cave2_spell5:IsPurgable()
    return false
end

function modifier_ability_npc_boss_cave2_spell5:RemoveOnDeath()
    return true
end

function modifier_ability_npc_boss_cave2_spell5:OnCreated()
    self.count = 0 
...
function modifier_ability_npc_boss_cave2_spell5:OnIntervalThink()
...
function modifier_ability_npc_boss_cave2_spell5:CheckState()
    return {
